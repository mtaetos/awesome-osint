...
This list was taken partially taken from [i-inteligence's](https://www.i-intelligence.eu) [OSINT Tools and Resources Handbook](https://www.i-intelligence.eu/open-source-intelligence-tools-and-resources-handbook/).
...
* [Threat Actor Usernames Scrape](https://github.com/spmedia/Threat-Actor-Usernames-Scrape) - A collection of fresh intel and 900k+ threat actor usernames scraped from various cybercrime sources & forums.
* [ThreatLens](https://github.com/AbdaullahAG/Threat_Intel_Project) - Professional multi-source Threat Intelligence CLI tool to investigate IPs, domains, hashes, and CVEs across multiple free APIs with automated log parsing and color-coded reporting.
